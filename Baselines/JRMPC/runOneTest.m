...
% read ply files
%%------------------------------------------------------------------------
kinectPly=sprintf('./syntheticData/Armadillo_Kinect.ply');
sfmPly=sprintf('./syntheticData/Armadillo_SFM.plyscalse.ply');
...
downRate1=1;
if(n1>1000)
    downRate1=round(n1/800);
end
if(n2>1000)
    downRate2=round(n2/800);
end
